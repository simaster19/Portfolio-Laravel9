...
@section('container')
    ...
    <div class="card-body">
        ...
        <form action="/project/{{ $dataProject->id }}" method="post" class="row g-3" enctype="multipart/form-data">
            @method('patch')
            @csrf

            <input type="hidden" name="id" value="{{ $dataProject->id }}">
            <input type="hidden" name="id_admin" value="{{ $dataProject->id_admin }}">
            <div class="col-md-5">
                <div class="form-floating mb-3">
                    <select name="jenis_project" class="form-select" id="floatingSelect" aria-label="State"
                        value={{ $dataProject->jenis_project }}>
            ...
            <div class="col-md-5">
                <div class="form-floating">
                    <input name="nama_project" type="text" class="form-control" id="floatingName"
                        placeholder="Nama Project" value="{{ $dataProject->nama_project }}" required>
            ...
            <div class="col-md-7">
                <div class="form-floating">
                    <input name="dibuat_dengan" type="text" class="form-control" id="floatingEmail"
                        placeholder="Dibuat Dengan" value="{{ $dataProject->dibuat_dengan }}" required>
            ...
            <div class="col-md-7">
                <div class="form-floating">
                    <textarea name="keterangan" class="form-control" placeholder="Keterangan" id="floatingTextarea" style="height: 100px;"
                        required>{{ $dataProject->keterangan }}</textarea>
